...
static int has_ext (char const* ext) {
  ...
  if (GLVersion.major < 3) {
    ...
    for (index = 0; index < num; index++) {
      char const* e = (char const*)glGetStringi (GL_EXTENSIONS, index);
...
static void load_GL_QCOM_driver_control (GLADloadproc load) {
  ...
  glad_glGetDriverControlStringQCOM =
      (PFNGLGETDRIVERCONTROLSTRINGQCOMPROC)load (
...
static void load_GL_OES_texture_border_clamp (GLADloadproc load) {
  ...
  glad_glGetSamplerParameterIuivOES =
      (PFNGLGETSAMPLERPARAMETERIUIVOESPROC)load (
...
static void load_GL_EXT_multi_draw_indirect (GLADloadproc load) {
  ...
  glad_glMultiDrawArraysIndirectEXT =
      (PFNGLMULTIDRAWARRAYSINDIRECTEXTPROC)load (
...
static void load_GL_OES_texture_storage_multisample_2d_array (
  ...
  glad_glTexStorage3DMultisampleOES =
      (PFNGLTEXSTORAGE3DMULTISAMPLEOESPROC)load (
...
static void load_GL_OES_EGL_image (GLADloadproc load) {
  ...
  glad_glEGLImageTargetTexture2DOES =
      (PFNGLEGLIMAGETARGETTEXTURE2DOESPROC)load (
...
static void load_GL_OES_draw_elements_base_vertex (GLADloadproc load) {
  ...
  glad_glMultiDrawElementsBaseVertexOES =
      (PFNGLMULTIDRAWELEMENTSBASEVERTEXOESPROC)load (
...
static void load_GL_EXT_texture_border_clamp (GLADloadproc load) {
  ...
  glad_glGetSamplerParameterIuivEXT =
      (PFNGLGETSAMPLERPARAMETERIUIVEXTPROC)load (
...
static void load_GL_OES_texture_3D (GLADloadproc load) {
  ...
  glad_glCompressedTexSubImage3DOES =
      (PFNGLCOMPRESSEDTEXSUBIMAGE3DOESPROC)load (
...
static void load_GL_ANGLE_instanced_arrays (GLADloadproc load) {
  ...
  glad_glDrawElementsInstancedANGLE =
      (PFNGLDRAWELEMENTSINSTANCEDANGLEPROC)load (
...
static void find_extensionsGLES2 (void) {
  ...
  GLAD_GL_OES_texture_cube_map_array =
      has_ext ("GL_OES_texture_cube_map_array");
  ...
  GLAD_GL_EXT_primitive_bounding_box =
      has_ext ("GL_EXT_primitive_bounding_box");
  ...
  GLAD_GL_NV_framebuffer_multisample =
      has_ext ("GL_NV_framebuffer_multisample");
  GLAD_GL_EXT_texture_filter_minmax = has_ext ("GL_EXT_texture_filter_minmax");
  ...
  GLAD_GL_OES_vertex_type_10_10_10_2 =
      has_ext ("GL_OES_vertex_type_10_10_10_2");
  GLAD_GL_APPLE_rgb_422             = has_ext ("GL_APPLE_rgb_422");
  ...
  GLAD_GL_AMD_compressed_3DC_texture =
      has_ext ("GL_AMD_compressed_3DC_texture");
  ...
  GLAD_GL_EXT_multiview_draw_buffers =
      has_ext ("GL_EXT_multiview_draw_buffers");
  ...
  GLAD_GL_OES_primitive_bounding_box =
      has_ext ("GL_OES_primitive_bounding_box");
  ...
  GLAD_GL_EXT_texture_cube_map_array =
      has_ext ("GL_EXT_texture_cube_map_array");
  ...
  GLAD_GL_AMD_compressed_ATC_texture =
      has_ext ("GL_AMD_compressed_ATC_texture");
  GLAD_GL_APPLE_texture_packed_float =
      has_ext ("GL_APPLE_texture_packed_float");
...
static void load_GL_VERSION_ES_CM_1_0 (GLADloadproc load) {
  ...
  glad_glGetTexParameteriv =
      (PFNGLGETTEXPARAMETERIVPROC)load ("glGetTexParameteriv");
  glad_glGetTexParameterxv =
      (PFNGLGETTEXPARAMETERXVPROC)load ("glGetTexParameterxv");
  glad_glHint            = (PFNGLHINTPROC)load ("glHint");
  glad_glIsBuffer        = (PFNGLISBUFFERPROC)load ("glIsBuffer");
  glad_glIsEnabled       = (PFNGLISENABLEDPROC)load ("glIsEnabled");
  glad_glIsTexture       = (PFNGLISTEXTUREPROC)load ("glIsTexture");
  ...
  glad_glPointParameterxv =
      (PFNGLPOINTPARAMETERXVPROC)load ("glPointParameterxv");
...
static void load_GL_OES_point_size_array (GLADloadproc load) {
  if (!GLAD_GL_OES_point_size_array)
    return;
  glad_glPointSizePointerOES =
      (PFNGLPOINTSIZEPOINTEROESPROC)load ("glPointSizePointerOES");
}
...
static void load_GL_OES_blend_subtract (GLADloadproc load) {
  if (!GLAD_GL_OES_blend_subtract)
    return;
  glad_glBlendEquationOES =
      (PFNGLBLENDEQUATIONOESPROC)load ("glBlendEquationOES");
}
...
static void load_GL_OES_matrix_palette (GLADloadproc load) {
  ...
  glad_glLoadPaletteFromModelViewMatrixOES =
      (PFNGLLOADPALETTEFROMMODELVIEWMATRIXOESPROC)load (
          "glLoadPaletteFromModelViewMatrixOES");
  glad_glMatrixIndexPointerOES =
      (PFNGLMATRIXINDEXPOINTEROESPROC)load ("glMatrixIndexPointerOES");
  glad_glWeightPointerOES =
      (PFNGLWEIGHTPOINTEROESPROC)load ("glWeightPointerOES");
}
...
static void load_GL_OES_framebuffer_object (GLADloadproc load) {
  if (!GLAD_GL_OES_framebuffer_object)
    return;
  glad_glIsRenderbufferOES =
      (PFNGLISRENDERBUFFEROESPROC)load ("glIsRenderbufferOES");
  glad_glBindRenderbufferOES =
      (PFNGLBINDRENDERBUFFEROESPROC)load ("glBindRenderbufferOES");
  glad_glDeleteRenderbuffersOES =
      (PFNGLDELETERENDERBUFFERSOESPROC)load ("glDeleteRenderbuffersOES");
  glad_glGenRenderbuffersOES =
      (PFNGLGENRENDERBUFFERSOESPROC)load ("glGenRenderbuffersOES");
  ...
  glad_glGetRenderbufferParameterivOES =
      (PFNGLGETRENDERBUFFERPARAMETERIVOESPROC)load (
          "glGetRenderbufferParameterivOES");
  glad_glIsFramebufferOES =
      (PFNGLISFRAMEBUFFEROESPROC)load ("glIsFramebufferOES");
  glad_glBindFramebufferOES =
      (PFNGLBINDFRAMEBUFFEROESPROC)load ("glBindFramebufferOES");
  glad_glDeleteFramebuffersOES =
      (PFNGLDELETEFRAMEBUFFERSOESPROC)load ("glDeleteFramebuffersOES");
  glad_glGenFramebuffersOES =
      (PFNGLGENFRAMEBUFFERSOESPROC)load ("glGenFramebuffersOES");
  ...
  glad_glFramebufferRenderbufferOES =
      (PFNGLFRAMEBUFFERRENDERBUFFEROESPROC)load (
          "glFramebufferRenderbufferOES");
  glad_glFramebufferTexture2DOES =
      (PFNGLFRAMEBUFFERTEXTURE2DOESPROC)load ("glFramebufferTexture2DOES");
  glad_glGetFramebufferAttachmentParameterivOES =
      (PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVOESPROC)load (
          "glGetFramebufferAttachmentParameterivOES");
  glad_glGenerateMipmapOES =
      (PFNGLGENERATEMIPMAPOESPROC)load ("glGenerateMipmapOES");
}
...
static void load_GL_OES_blend_func_separate (GLADloadproc load) {
  if (!GLAD_GL_OES_blend_func_separate)
    return;
  glad_glBlendFuncSeparateOES =
      (PFNGLBLENDFUNCSEPARATEOESPROC)load ("glBlendFuncSeparateOES");
}
...
static void find_extensionsGLES1 (void) {
  ...
  GLAD_GL_AMD_compressed_ATC_texture =
      has_ext ("GL_AMD_compressed_ATC_texture");
  GLAD_GL_OES_texture_mirrored_repeat =
  ...
  GLAD_GL_OES_required_internalformat =
      has_ext ("GL_OES_required_internalformat");
  GLAD_GL_OES_extended_matrix_palette =
      has_ext ("GL_OES_extended_matrix_palette");
  GLAD_GL_APPLE_texture_max_level = has_ext ("GL_APPLE_texture_max_level");
  GLAD_GL_EXT_multisampled_render_to_texture =
      has_ext ("GL_EXT_multisampled_render_to_texture");
  GLAD_GL_QCOM_writeonly_rendering = has_ext ("GL_QCOM_writeonly_rendering");
  ...
  GLAD_GL_APPLE_texture_2D_limited_npot =
      has_ext ("GL_APPLE_texture_2D_limited_npot");
  GLAD_GL_OES_EGL_image        = has_ext ("GL_OES_EGL_image");
  GLAD_GL_QCOM_extended_get    = has_ext ("GL_QCOM_extended_get");
  GLAD_GL_OES_query_matrix     = has_ext ("GL_OES_query_matrix");
  ...
  GLAD_GL_OES_blend_equation_separate =
      has_ext ("GL_OES_blend_equation_separate");
  GLAD_GL_OES_stencil4           = has_ext ("GL_OES_stencil4");
