...
file(WRITE "${CMAKE_SOURCE_DIR}/build-scripts/${target}VersionH.cmake" "
...
#define ${target_upper}_VERSION ${version}
...
add_custom_command(TARGET ${target} PRE_BUILD COMMAND ${CMAKE_COMMAND} -P "${CMAKE_SOURCE_DIR}/build-scripts/${target}VersionH.cmake")
endfunction()